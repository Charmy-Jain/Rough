...
const ForgotPasswordPage = () => {
	...
	return (
		<motion.div
			...
			className='w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lgmax-w-md bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'
		>
			<div className='p-8'>
